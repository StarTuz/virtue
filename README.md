# Virtue: The Spiritual Successor

> "To see the world as it truly is, to feel the connection between all living things, and to endure despite adversity."

**Virtue** is an open-source, community-driven RPG set in the world of **Veridia**. It is a spiritual successor to the *Ultima* series, built on **Unreal Engine 5**.
